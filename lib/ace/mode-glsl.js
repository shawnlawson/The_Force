...
var glslHighlightRules = function() {
    ...
    var storage = (
        "in|out|inout|float|int|bool|mat2|mat3|" +
        "mat4|vec2|vec3|vec4|ivec2|ivec3|ivec4|bvec2|bvec3|bvec4|struct|void"
    );
    ...
    var headerFunctions = (
        "rand|box|circle|snoise|sexy|nyanFrame"
        );
